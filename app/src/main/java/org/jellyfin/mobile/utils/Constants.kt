...
object Constants {
    ...
    const val PREF_PREFER_OFFLINE_DOWNLOADS = "pref_prefer_offline_downloads"
    ...
    const val EXPIRATION_NOTIFICATION_CHANNEL_ID = "org.jellyfin.mobile.download.EXPIRATION_WARNING"
